...
```{note}
動画の尺変更などが原因で同じ名前の違う内容の動画を読み込みたいとき、<BR>
動画のRemove＞Keep＞再読み込みとするとピックアップしたフレーム位置にずれが発生し、<BR>
想定していないアニメーション結果になる場合があります。<BR>
...
<img  src="https://github.com/ZukunFCS/fcs-doc/blob/main/doc/images/FCSMenu_Timeline004.jpg">
